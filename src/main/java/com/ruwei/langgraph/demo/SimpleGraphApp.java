package com.ruwei.langgraph.demo;

import org.bsc.langgraph4j.GraphRepresentation;
import org.bsc.langgraph4j.StateGraph;
import org.bsc.langgraph4j.GraphStateException;
import org.openqa.selenium.devtools.v135.audits.model.BounceTrackingIssueDetails;
...
public class SimpleGraphApp {
    ...
    public static void main(String[] args) throws GraphStateException {
       ...
       var stateGraph = new StateGraph<>(SimpleState.SCHEMA, initData -> new SimpleState(initData))
        ...
        stateGraph.getGraph(GraphRepresentation.Type.MERMAID,"demo");
